    ...
    try {
        ...
        function criarTabela(perguntasGrupo, colunas) {
            ...
            doc.autoTable({
                ...
                body: rows,
                theme: 'grid',
                styles: { halign: 'center', valign: 'middle', fontSize: 10, lineColor: [0, 0, 0], lineWidth: 0.3 },
                margin: { left: 10, right: 10 },
            });
            y = doc.lastAutoTable.finalY + 5;
        }

        await criarTabela(perguntas.slice(0, 3), 3);
        await criarTabela(perguntas.slice(3, 36), 3);

        if (y + 50 > altura - 50) { doc.addPage(); y = 20; }
        doc.setFontSize(11);
