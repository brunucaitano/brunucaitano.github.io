    ...
    try {
        ...
        function desenharTabela(perguntasGrupo, colunas) {
            ...
            for (let i = 0; i < perguntasGrupo.length; i += colunas) {
                if (y + 10 > altura - 50) { doc.addPage(); y = 20; yInicial = y; }
                let x = 10;
                for (let j = 0; j < colunas; j++) {
                    let p = perguntasGrupo[i + j];
                    if (p) {
        ...
        if (y + 15 > altura - 50) { doc.addPage(); y = 20; }
        ...
        doc.text(obs, largura / 2, y + 2, { align: "center" });
        y += obsAltura + 10;
        ...
        for (let file of arquivos) {
            ...
            if (y + tamanhoImagem > altura - 50) { doc.addPage(); y = 20; x = 10; linha = 0; }
        ...
        if (y + 30 > altura - 50) { doc.addPage(); y = 20; }
